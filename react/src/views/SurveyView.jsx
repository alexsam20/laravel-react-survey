          ...
          <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
            ...
            <div>
              ...
              <div className="mt-1 flex items-center">
                ...
                <button
                  type="button"
                  className="relative ml-5 rounded-md border border-gray-300 bg-white py-2 px-3 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:border-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  <input
                    type="file"
            ...
            <div className="col-span-6 sm:col-span-3">
              ...
              <textarea
                ...
                placeholder="Describe you survey"
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-50 focus:ring-indigo-500 sm:text-sm"
              ></textarea>
            </div>
            {/*Description*/}
